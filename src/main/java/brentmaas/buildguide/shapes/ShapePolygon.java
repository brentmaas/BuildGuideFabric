...
public class ShapePolygon extends Shape{
	...
	private PropertyMinimumInt propertySides = new PropertyMinimumInt(0, 145, 3, new TranslatableText("property.buildguide.sides"), () -> {this.update();}, 3);
	...
	private PropertyEnum<direction> propertyDir = new PropertyEnum<direction>(0, 185, direction.X, new TranslatableText("property.buildguide.direction"), () -> {this.update();}, directionNames);
	private PropertyEnum<rotation> propertyRot = new PropertyEnum<rotation>(0, 205, rotation.ROT0, new TranslatableText("property.buildguide.rotation"), () -> {this.update();}, rotationNames);
	private PropertyNonzeroInt propertyHeight = new PropertyNonzeroInt(0, 225, 1, new TranslatableText("property.buildguide.height"), () -> {this.update();});
