...
public class ShapeParaboloid extends Shape{
	...
	private PropertyPositiveInt propertyHalfwidth1 = new PropertyPositiveInt(1, 3, new TranslatableText("property.buildguide.halfwidthdir", "Y"), () -> update());
	private PropertyPositiveInt propertyHalfwidth2 = new PropertyPositiveInt(2, 3, new TranslatableText("property.buildguide.halfwidthdir", "Z"), () -> update());
	private PropertyNonzeroInt propertyHeight = new PropertyNonzeroInt(3, 3, new TranslatableText("property.buildguide.height"), () -> update());
	...
	protected void updateShape(BufferBuilder builder) {
		...
		switch(propertyDir.value) {
		case X:
			propertyHalfwidth1.setName(new TranslatableText("property.buildguide.halfwidthdir", "Y"));
			propertyHalfwidth2.setName(new TranslatableText("property.buildguide.halfwidthdir", "Z"));
			break;
		case Y:
			propertyHalfwidth1.setName(new TranslatableText("property.buildguide.halfwidthdir", "X"));
			propertyHalfwidth2.setName(new TranslatableText("property.buildguide.halfwidthdir", "Z"));
			break;
		case Z:
			propertyHalfwidth1.setName(new TranslatableText("property.buildguide.halfwidthdir", "X"));
			propertyHalfwidth2.setName(new TranslatableText("property.buildguide.halfwidthdir", "Y"));
			break;
		}
	}
