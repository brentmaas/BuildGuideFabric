...
public class ShapeSphere extends Shape{
	...
	private PropertyPositiveInt propertyRadius = new PropertyPositiveInt(0, 3, new TranslatableText("property.buildguide.radius"), () -> this.update());
	private PropertyEnum<dome> propertyDome = new PropertyEnum<dome>(1, dome.NO, new TranslatableText("property.buildguide.dome"), () -> this.update(), domeNames);
