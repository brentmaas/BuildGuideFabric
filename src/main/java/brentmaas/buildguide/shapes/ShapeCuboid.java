...
public class ShapeCuboid extends Shape{
	...
	private PropertyNonzeroInt propertyX = new PropertyNonzeroInt(0, 145, 3, new LiteralText("X"), () -> {this.update();});
	private PropertyNonzeroInt propertyY = new PropertyNonzeroInt(0, 165, 3, new LiteralText("Y"), () -> {this.update();});
	private PropertyNonzeroInt propertyZ = new PropertyNonzeroInt(0, 185, 3, new LiteralText("Z"), () -> {this.update();});
	private PropertyEnum<walls> propertyWalls = new PropertyEnum<walls>(0, 205, walls.ALL, new TranslatableText("property.buildguide.walls"), () -> {this.update();}, wallsNames);
