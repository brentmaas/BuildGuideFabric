...
public class ShapeParabola extends Shape{
	...
	private PropertyPositiveInt propertyHalfwidth = new PropertyPositiveInt(2, 3, new TranslatableText("property.buildguide.halfwidth"), () -> update());
	private PropertyPositiveInt propertyHeight = new PropertyPositiveInt(3, 3, new TranslatableText("property.buildguide.height"), () -> update());
	private PropertyNonzeroInt propertyDepth = new PropertyNonzeroInt(4, 1, new TranslatableText("property.buildguide.depth"), () -> update());
