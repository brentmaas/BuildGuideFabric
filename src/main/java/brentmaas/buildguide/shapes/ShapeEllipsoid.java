...
public class ShapeEllipsoid extends Shape{
	...
	private PropertyPositiveInt propertySemiX = new PropertyPositiveInt(0, 3, new TranslatableText("property.buildguide.semiaxis", "X"), () -> this.update());
	private PropertyPositiveInt propertySemiY = new PropertyPositiveInt(1, 3, new TranslatableText("property.buildguide.semiaxis", "Y"), () -> this.update());
	private PropertyPositiveInt propertySemiZ = new PropertyPositiveInt(2, 3, new TranslatableText("property.buildguide.semiaxis", "Z"), () -> this.update());
	private PropertyEnum<dome> propertyDome = new PropertyEnum<dome>(3, dome.NO, new TranslatableText("property.buildguide.dome"), () -> this.update(), domeNames);
