...
public class ShapeEllipsoid extends Shape{
	...
	private PropertyPositiveInt propertySemiX = new PropertyPositiveInt(0, 145, 3, new TranslatableText("property.buildguide.semiaxis", "X"), () -> {this.update();});
	private PropertyPositiveInt propertySemiY = new PropertyPositiveInt(0, 165, 3, new TranslatableText("property.buildguide.semiaxis", "Y"), () -> {this.update();});
	private PropertyPositiveInt propertySemiZ = new PropertyPositiveInt(0, 185, 3, new TranslatableText("property.buildguide.semiaxis", "Z"), () -> {this.update();});
	private PropertyEnum<dome> propertyDome = new PropertyEnum<dome>(0, 205, dome.NO, new TranslatableText("property.buildguide.dome"), () -> {this.update();}, domeNames);
