...
public class ShapeEllipse extends Shape {
	...
	private PropertyPositiveInt propertySemi1 = new PropertyPositiveInt(0, 165, 3, new TranslatableText("property.buildguide.semiaxis", "Y"), () -> {this.update();});
	private PropertyPositiveInt propertySemi2 = new PropertyPositiveInt(0, 185, 3, new TranslatableText("property.buildguide.semiaxis", "Z"), () -> {this.update();});
	private PropertyNonzeroInt propertyHeight = new PropertyNonzeroInt(0, 205, 1, new TranslatableText("property.buildguide.height"), () -> {this.update();});
	...
	protected void updateShape(BufferBuilder builder) {
		...
		switch(propertyDir.value) {
		case X:
			propertySemi1.setName(new TranslatableText("property.buildguide.semiaxis", "Y"));
			propertySemi2.setName(new TranslatableText("property.buildguide.semiaxis", "Z"));
			break;
		case Y:
			propertySemi1.setName(new TranslatableText("property.buildguide.semiaxis", "X"));
			propertySemi2.setName(new TranslatableText("property.buildguide.semiaxis", "Z"));
			break;
		case Z:
			propertySemi1.setName(new TranslatableText("property.buildguide.semiaxis", "X"));
			propertySemi2.setName(new TranslatableText("property.buildguide.semiaxis", "Y"));
			break;
		}
	}
