...
public class ShapeEllipse extends Shape {
	...
	private PropertyPositiveInt propertySemi1 = new PropertyPositiveInt(1, 3, new TranslatableText("property.buildguide.semiaxis", "Y"), () -> this.update());
	private PropertyPositiveInt propertySemi2 = new PropertyPositiveInt(2, 3, new TranslatableText("property.buildguide.semiaxis", "Z"), () -> this.update());
	private PropertyNonzeroInt propertyHeight = new PropertyNonzeroInt(3, 1, new TranslatableText("property.buildguide.height"), () -> this.update());
